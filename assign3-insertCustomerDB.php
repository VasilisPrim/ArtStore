            ...
            <h2>Customer Registration</h2>
                ...
                <?php
                    if ($_SERVER["REQUEST_METHOD"] != "POST") {
                        echo  "Please fill the <a href='assign3-insertCustomer.php'> form </a> first "; 
                        exit;
                    }
                    try {
                        ...
                        $stmt = $conn->prepare("INSERT INTO customer (first_name, last_name,birth_date,email,phone,address,city,state,zip,country )
                        VALUES (:first_name,:last_name,:birth_date,:email,:phone,:address,:city,:state,:zip,:country)");
                        ...
                        $stmt->bindParam(':state', $_POST['state/region']);
                ...
                <div class="customer-data">
                    ...
                    <p id="update-message"><b><?php echo $_POST["firstname"]." ".$_POST["lastname"]?></b> your personal details have been saved succesfully! <a href="assign3-getCustomers.php">Go to the customers page</a></p>
