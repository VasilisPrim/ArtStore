    ...
    <main class="main-b">
        ...
        <section class="section-2b">
            <div class="form-2b">
                ...
                <?php
                if (!isset($_GET['id']) ) {
                    echo  "Please choose a <a href='getCustomers.php'> Customer </a> first "; 
                    exit;
                }
                try {
                ...
                ?>
                <form action="assign3-updateCustomerDB.php" method="GET" class="form" >
                    <div class="one-b">
                        <div>
                            <label>Email*</label>
                            <input type="email" name="email" value="<?php echo $row[0]['email'];  ?>">
                        </div>
                        <div>
                    ...
                    <div class="two-b">
                        <div>
                            ...
                            <input type="text" name="firstname" value="<?php echo $row[0]['first_name'];  ?>" >
                        </div>
                        <div>
                            <label>Last Name*</label>
                            <input type="text" name="lastname" value="<?php echo $row[0]['last_name'];  ?>">
                        </div>
                        <div>
                            <label>Birth Date</label>
                            <input type="date" name="birthdate" value="<?php echo $row[0]['birth_date'];  ?>" ></div>
                    </div>
                    <h3 class="contact-header">Contact</h3>
                    <div class="three-b">
                        <div>
                            <label>Address</label>
                            <input type="text" name="address" value="<?php echo $row[0]['address'];  ?>">
                        </div>
                        <div>
                            <label>State/Region</label>
                            <input type="text" name="state/region" value="<?php echo $row[0]['state'];  ?>">
                        </div>
                        <div>
                            <label>City</label>
                            <input type="text" name="city" value="<?php echo $row[0]['city'];  ?>" >
                        </div>
                        <div>
                            <label>Zip</label>
                            <input type="text" name="zip" value="<?php echo $row[0]['zip'];  ?>" >
                        </div>
                        <div>
                            <label>Country</label>
                            <select name="country" >
                        ...
                        <div>
                            <label>Mobile*</label>
                            <input name="mobile" type="tel" value="<?php echo $row[0]['phone'];  ?>">
                        </div>
